...
-- 資料庫： `060121_xampp`
--
CREATE DATABASE IF NOT EXISTS `060121_xampp` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `060121_xampp`;
...
INSERT INTO `manager` (`userid`, `pwd`) VALUES
('', '111'),
('111', '111');
...
--
ALTER TABLE `dailytime`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主件', AUTO_INCREMENT=4;
